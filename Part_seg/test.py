...
parser.add_argument('--model_path', default='train_transform_models_k=25/trained_models/epoch_100.ckpt', help='Model checkpoint path')
...
gpu_to_use = 0
output_dir = os.path.join(BASE_DIR, './test_transform_results_k=25')
