...
import provider
import part_seg_model_new as model
...
parser.add_argument('--output_dir', type=str, default='train_transform_models_k=25', help='Directory that stores all training logs and trained models')
...
MODEL_STORAGE_PATH = os.path.join(output_dir, 'train_transform_models_k=25')
